...
public class StackDemo {
    public static void main(String[] args) {
        ...
        int position = books.search(book2); // mencari book2

        if (position != -1) {
            System.out.println("Book ditemukan di posisi ke-" + position + " dari atas stack.");
        } else {
            System.out.println("Book tidak ditemukan di dalam stack.");
        }
    }
}
