public class BinaryTreeMain02 {
    public static void main(String[] args) {
        ...
        // bst.add(new Mahasiswa02("244160170", "Candra", "C", 3.21));
        // bst.add(new Mahasiswa02("244160185", "Fizi", "B", 3.46));
        ...
        // bst.add(new Mahasiswa02("244160121", "Fizi", "B", 3.46));
        ...
        bst.addRekursif(new Mahasiswa02("244160121", "Ali", "A", 3.57));
        bst.addRekursif(new Mahasiswa02("244160185", "Candra", "C", 3.41));
        bst.addRekursif(new Mahasiswa02("244160221", "Badar", "B", 3.75));
        bst.addRekursif(new Mahasiswa02("244160220", "Dewi", "B", 3.35));
